...
const Dashboard = () => {
    ...
    return (
        <div className="md:flex md:min-h-screen">
            {/* Sidebar */}
            <div className={`md:w-1/5 bg-gradient-to-r from-black to-[#67841e] px-5 py-4 ${menuOpen ? 'block' : 'hidden'} md:block`}>
                            ...
                            <Link
                                ...
                                className={`${
                                    urlActual === link.to
                                        ...
                                        : 'text-[#F7F3E9]'
                                } text-base block mt-2 hover:text-[#FFD700] my-3`}
            ...
            <div className="flex-1 flex flex-col justify-between h-screen bg-[#F7F3E9]">
                {/* Encabezado */}
                <div className="bg-[#67841e] py-2 flex items-center justify-between md:justify-end px-4">
