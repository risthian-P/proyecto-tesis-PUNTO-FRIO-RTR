...
const Perfil = () => {
    return (
        <>       
            <div>
                <h1 className='font-black text-4xl text-gray-500'>Perfil del usuario</h1>
                <hr className='my-4' />
                <p className='mb-8'>Este módulo te permite visualizar y modificar los campos del usuario</p>
            </div>
